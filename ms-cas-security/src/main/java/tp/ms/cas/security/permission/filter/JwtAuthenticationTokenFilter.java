...
public class JwtAuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        if(user == null) {
        	Authentication arth = SecurityContextHolder.getContext().getAuthentication();
        	if(arth != null) {
            	Object authToken = arth.getPrincipal();
        		if(authToken instanceof JwtUser) {
        			JwtUser jwt = (JwtUser) authToken;
        			MsEnvContextHolder.getContext().setUser(jwt.getAfterAuthenticationUser());
        		}
        	}
        }
