...
public class SingleUpdateBPTemplate<T extends BaseVO, E extends BaseExample> {


	static final Logger log = LoggerFactory.getLogger(SingleUpdateBPTemplate.class);
	...
	public SingleUpdateBPTemplate(ISingleService<T, E> service) {
		ICompareOperator<T> operator = new SingleUpdateOperator<T, E>(service);
	...
	public T update(T fullBills, T originBills) throws ADBusinessException {
