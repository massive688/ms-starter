...
import com.ms.core.service.rest.common.vo.MajorBaseVO;
import com.ms.core.service.rest.context.supper.BeanHelperEnv;
import com.ms.data.cache.context.MsEnvContextHolder;

//@Aspect
@Component
public class MajorServiceOperationAspect {

	@Autowired
	BeanHelperEnv beanHelper;

//	@Pointcut("target(com.ms.core.service.rest.common.service.IMajorService<T, E>)")
	public void daoMapperPintCut() {
	}
	
//	@Around("daoMapperPintCut() && args(com.ms.core.service.rest.common.vo.MajorBaseVO)")
	public void pointBefore(ProceedingJoinPoint point) throws Throwable {
