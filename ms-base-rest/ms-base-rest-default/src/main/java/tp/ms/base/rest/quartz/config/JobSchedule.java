...
//     * 
//     */
//    public static void addJob(String jobName, Class<? extends Job> cls, String cron)
//            throws SchedulerException {
...
//            String triggerName, String triggerGroupName, Class<? extends Job> cls, String cron)
//            throws SchedulerException {
//
//        Scheduler sched = gSchedulerFactory.getScheduler();
//        // 用于描叙Job实现类及其他的一些静态信息，构建一个作业实例
