...
//    		druidXA.setSharePreparedStatements(true);
//    		druidXA.setValidationQuery("SELECT 1");
//    		xaDataSource = druidXA;
//    	}
//    	
//
//		DruidDataSource dataSource = new DruidDataSource();
//		dataSource.setUrl(dssProp.getUrl());
//		dataSource.setDriverClassName(dssProp.getDriverClassName());
//		dataSource.setDbType(dssProp.getDbType());
//		dataSource.setPassword(dssProp.getPassword());
//		dataSource.setUsername(dssProp.getUsername());
...
//		atomikosDataSource.setUniqueResourceName(dssProp.getKey()+"DataSource");
//		Properties xaProperties = bindProp(xaProp);
//		atomikosDataSource.setMinPoolSize(xaProp.getMinPoolSize());
//		atomikosDataSource.setMaxPoolSize(xaProp.getMaxPoolSize());
//		atomikosDataSource.setMaxLifetime(xaProp.getMaxLifetime());
//		atomikosDataSource.setBorrowConnectionTimeout(xaProp.getBorrowConnectionTimeout());
//		try {
//			atomikosDataSource.setLoginTimeout(xaProp.getLoginTimeout());
//		} catch (SQLException e) {
//		}
//		atomikosDataSource.setMaintenanceInterval(xaProp.getMaintenanceInterval());
//		atomikosDataSource.setMaxIdleTime(xaProp.getMaxIdleTime());
//		atomikosDataSource.setTestQuery(xaProp.getTestQuery());
//		atomikosDataSource.setXaProperties(xaProperties);
//		  
//		// bean定义类
//		GenericBeanDefinition define = new GenericBeanDefinition();
//	    // 设置bean的类型，此处AtomikosDataSourceBean是继承XADataSource的实现类
//	    define.setBeanClass(DruidDataSource.class);
//	    define.setPrimary(isPrimary);
//	    // 需要注入的参数
//	    MutablePropertyValues mpv = define.getPropertyValues();
//		mpv.add("url", dssProp.getUrl());
//		mpv.add("driverClassName", dssProp.getDriverClassName());
//		mpv.add("dbType", dssProp.getDbType());
//		mpv.add("password", dssProp.getPassword());
//		mpv.add("username", dssProp.getUsername());
//		mpv.add("sharePreparedStatements", true);
//		mpv.add("validationQuery", "SELECT 1");
//		mpv.add("minPoolSize", xaProp.getMinPoolSize());
//		mpv.add("maxPoolSize", xaProp.getMaxPoolSize());
//		mpv.add("maxLifetime", xaProp.getMaxLifetime());
//		mpv.add("borrowConnectionTimeout", xaProp.getBorrowConnectionTimeout());
