...
public final class ThreadPoolManager {
	...
	// 线程池维护线程的最少数量
	private static final int SIZE_CORE_POOL = 10;//Runtime.getRuntime().availableProcessors();

	// 线程池维护线程的最大数量
	private static final int SIZE_MAX_POOL = 25;//Runtime.getRuntime().availableProcessors()*2+1;
...
//		scheduler.shutdown();
	...
	public void finish() {
		while(!isTaskEnd() || hasMoreAcquire()) {
			try {
