...
//     */
//	@Pointcut("@within(tp.ms.common.batis.annotation.TargetDataSource) "
//			+ "|| @annotation(tp.ms.common.batis.annotation.TargetDataSource)")
//	protected void sourceAspect() {}
//	@Pointcut("target(tp.ms.base.rest.resource.service.IBaseService) "
//			+ "&& @target(tp.ms.common.batis.annotation.TargetDataSource)")
//	protected void sourceServiceAspect() {}
//	/**
//	 * 怎么都拦截不了注解
//	 */
////	@Pointcut("target(tp.ms.common.batis.mapper.SuperDaoMapper) "
////			+ "&& @target(tp.ms.common.batis.annotation.TargetDataSource)")
////	protected void sourceMapperAspect() {}
//
//	@Pointcut("target(tp.ms.common.batis.mapper.SuperDaoMapper) || execution(* tp.ms.common.batis.mapper..*(..))")
//	protected void sourceMapperAspect() {}
//
//
//
...
//		MsDynamicDataSourceContextHolder.setDataSourceRouterKey(targetSource);
//	}
//	/**
//	 * 通过类找注解
//	 * @param clazz
