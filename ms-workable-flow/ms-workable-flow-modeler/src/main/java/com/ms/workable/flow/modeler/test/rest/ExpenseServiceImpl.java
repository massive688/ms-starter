...
public class ExpenseServiceImpl implements IExpenseService {
    ...
    private void deleteById(Integer expenseId) {
		// TODO Auto-generated method stub
    ...
    public void pass(String taskId) {
        ...
        ProcessInstance pi = runtimeService.createProcessInstanceQuery()//
                ...
                .singleResult();
        Wrapper wrapper = new EntityWrapper<Expense>().eq("processId", task.getProcessInstanceId());
	...
	@Override
	public List<Map<String, Object>> selectMaps(EntityWrapper<Expense> expenseEntityWrapper) {
		// TODO Auto-generated method stub
		return null;
	}
