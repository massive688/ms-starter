...
public class ShiroKit {
    ...
    public static List<Integer> getDeptDataScope() {
        ...
        List<Integer> subDeptIds = new ArrayList<Integer>();//ConstantFactory.me().getSubDeptId(deptId);
    ...
    public static boolean isAdmin() {
        ...
        for (Integer integer : roleList) {
            String singleRoleTip = "isAdmin";//ConstantFactory.me().getSingleRoleTip(integer);
